 ...
 * Date: July 17, 2015
 * */
public class EarthquakeCityMap_Akos_working_ULTIMATE_noComments extends PApplet {
	...
	public void setup() {
	    ...
	    if (earthquakes.size() > 0) {
	    	...
	    	//this can be used for displaying the recent quakes:
	    	Object ageObj = f.getProperty("age");
	    	System.out.println("Age is: " + ageObj);
