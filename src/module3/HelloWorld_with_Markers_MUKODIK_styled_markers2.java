...
public class HelloWorld_with_Markers_MUKODIK_styled_markers2 extends PApplet
{
	...
	public void setup() {
		...
		*/
	    ...
	    fehervarMarker = new SimplePointMarker(fehervarLocation);
	    ...
	    */
	    ...
	    map2.addMarkers(berlinMarker, dublinMarker, sandiegoMarker);
	...
	public void draw() {
		...
		ScreenPosition fehervarPos = fehervarMarker.getScreenPosition(map2);
		  strokeWeight(16);
		  stroke(67, 211, 227, 100);
		  noFill();
		  ellipse(fehervarPos.x, fehervarPos.y, 36, 36);
	}
