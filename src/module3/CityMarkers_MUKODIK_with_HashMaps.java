...
/** HelloWorld
  ...
  * Date: May, 20, 2016V
*/
public class CityMarkers_MUKODIK_with_HashMaps extends PApplet
{
	...
	List<Feature> myJSONObject;
	/*
	 * {"type":"FeatureCollection","features":[
{"type":"Feature","properties":{"name":"Berlin", 
"population":"3.375", "country" : "Germany", "coastal" : "false"},
"geometry":{"type":"Point","coordinates":[13.383, 52.5167]}},
...
]}
	 */
	...
	public void setup() {
		...
		*/
		...
		List<Feature> myJSONObject = GeoJSONReader.loadData(this, cityFile);
		println("Loaded " + myJSONObject.size() + " data entries");
		Class cls1 = myJSONObject.getClass();
		println("myJSONObject's type is " + cls1.getName());
		
		Class cls2 = cityFile.getClass();
		println("cityFile's type is " + cls2.getName());

		int[] test = {20, -10, 15, -7, -8, 45};
		Class cls3 = test.getClass();
		println("test variable's type is " + cls3.getName());
		
		cityMarkers = new ArrayList<Marker>();
		//List<Marker> cityMarkers = new ArrayList<Marker>();
		for(Feature city : myJSONObject) {
