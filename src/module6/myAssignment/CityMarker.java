...
public class CityMarker extends CommonMarker {
	...
	public static int RECT_SIZE = 10;  // The size of the rectangle marker
...
y3 	float: y-coordinate of the third point
		 */
		pg.rect(x-RECT_SIZE/2, y-RECT_SIZE/2, RECT_SIZE, -1*(RECT_SIZE+(RECT_SIZE*getPopulation()/5)));
		//pg.rect(x-RECT_SIZE/2, y-RECT_SIZE/2, RECT_SIZE, RECT_SIZE);
